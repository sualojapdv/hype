...
trait BsPayTrait
{
     ...
     * @return array
     */
    public static function requestQrcodeBS($request)
    {
        if($access_token = self::generateCredentials()) {
            ...
            $postback = "https//" . $_SERVER['SERVER_NAME'] . "/bspay/callback";
            $randomCode = str_random(8);
            $email = auth()->user()->email ?? auth()->user()->name . $randomCode . "@gmail.com";
            ...
            ])->post('https://api.bspay.co/v2/pix/qrcode', $parameters);
