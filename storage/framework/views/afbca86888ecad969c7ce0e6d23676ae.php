...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['type' => 'submit','form' => 'submit','class' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','form' => 'submit','class' => 'w-full']); ?>
                Carregar Arquivo
...
<?php endif; ?>
<?php /**PATH /home/u295945790/domains/roxgames777.shop/public_html/resources/views/filament/pages/advanced-page.blade.php ENDPATH**/ ?>