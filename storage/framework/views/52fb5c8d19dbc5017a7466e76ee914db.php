...
<div class="fi-wi-stats-overview-stat relative rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
    ...
    <div class="relative mt-2 rounded-md shadow-sm w-full">
        <div class="pointer-events-none absolute right-0 flex items-center pr-3 px-5" style="position:absolute; right: 0; padding: 7px; fill: #cccccc">
        ...
        <input wire:click="copyReferCode()" type="text"
               name="convite"
               id="convite"
               ...
               value="<?php echo e(url('/register?code='.auth()->user()->inviter_code)); ?>"
        />
    </div>
</div>
<?php /**PATH /home/wellbet777/htdocs/wellbet777.com/resources/views/filament/components/convite.blade.php ENDPATH**/ ?>