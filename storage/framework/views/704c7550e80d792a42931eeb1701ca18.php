...
<html lang="zn-CN" data-data="网站主体" data-version="<?php echo e(now()->toString()); ?>" class="网站主体" data-city="São Paulo/Brazil" data-developer="daanrox.com">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;900&display=swap" rel="stylesheet"> <!-- Fonte Orbitron adicionada -->
    ...
    <body id="罗克斯系统" color-theme="dark" class="bg-base text-gray-800 dark:text-gray-300 ">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Verifica se o usuário já foi redirecionado para a página de registro
                if (!localStorage.getItem('userRegistered')) {
                    // Redireciona para a página de registro
                    window.location.href = '/register';
                    // Marca o usuário como registrado para que não seja redirecionado novamente
...
<?php /**PATH /home/winbet777/htdocs/winbet777.com.br/resources/views/layouts/app.blade.php ENDPATH**/ ?>