      ...
      <div v-if="wallet && setting">
          <div class="">
              ...
              <ul>
                  ...
                  <li v-if="setting.sharkpay_is_enable" @click="setPaymentMethod('pix', 'sharkpay')" class="bg-white dark:bg-gray-900 cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-2">
                      <div>
                          <p>SHARKPAY</p>
                      </div>
                      <div>
